...
describe Contribution do
  ...
  describe 'Contribution#rate' do
    it 'increases the rating total and number of ratings' do
      test_contrib = Contribution.create(name: "Halo", content: "Fun sci-fi shooter.", rating_total: 0, rating_count: 0)
      test_contrib.rate(4)
  ...
  describe 'Contribution#rating' do
    it 'shows the rating as an average of all ratings divided by number of ratings' do
      test_contrib = Contribution.create(name: "Halo", content: "Fun sci-fi shooter.", rating_total: 12, rating_count: 3)
